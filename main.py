...
def start_training(char_name: str, char_class: str) -> str:
    """Сообщает о навыках и предлагает их потренировать."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Предлагает выбор роли и фиксирует выбор."""
    approve_choice: str = ''
    char_class: str = ''
...
if __name__ == '__main__':
    """Starting message and animation."""
    run_screensaver()
